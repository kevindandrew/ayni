// Centralized SVG icon components — Heroicons v2 style (24x24, stroke 1.5)
...
// Custom paw icon (filled) for animals
export const PawIcon = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <ellipse cx="8.5" cy="5.5" rx="2" ry="2.5" />
    <ellipse cx="15.5" cy="5.5" rx="2" ry="2.5" />
    <ellipse cx="4" cy="11.5" rx="1.75" ry="2" />
    <ellipse cx="20" cy="11.5" rx="1.75" ry="2" />
    <path d="M12 10c-3.6 0-6.5 2-6.5 5.5 0 .8-.2 2 1 3 1 .8 2.5 1 3.5 1h4c1 0 2.5-.2 3.5-1 1.2-1 1-2.2 1-3C18.5 12 15.6 10 12 10z" />
  </svg>
);
...
export const ShieldAlertIcon = ({ className }) => (
  <Svg className={className}>
